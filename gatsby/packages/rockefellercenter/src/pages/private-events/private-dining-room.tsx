...
export default function PrivateDiningRoomPage({
  data,
}: {
  ...
  return (
    <Layout theme="Rock Center">
      <PrivateEventsVenueHeroBlock
        theme="Rock Center Black"
        title="Private Events at The Private Dining Room"
        backLink={{
          url: '/private-events',
...
export const query = graphql`
  query sanityPrivateDiningVenue {
    meta: privateEventVenuesJson(id: {eq: "private-dining-room"}) {
      meta {
        title
        description
      }

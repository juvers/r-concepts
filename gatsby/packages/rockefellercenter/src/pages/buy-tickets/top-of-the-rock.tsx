...
export default function TopOfTheRockTickets({
  data,
}: {
  data: GatsbyTypes.BuyTicketsTorQuery;
}): JSX.Element {
...
export const query = graphql`
  query BuyTicketsTor {
    page: buyTicketsFlowJson(id: {eq: "buy-tickets-tor"}) {
      hero {
        title
        link {
          label
    ...
    meta: buyTicketsFlowJson(id: {eq: "buy-tickets-tor"}) {
      meta {
        title
        description
      }

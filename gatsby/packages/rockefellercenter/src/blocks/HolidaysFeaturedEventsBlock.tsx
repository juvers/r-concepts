...
const HOLIDAYS_FEATURED_EVENTS_QUERY = graphql`
  query HolidaysFeaturedEvents {
    featuredEvents: sanityAttractionHoliday(
      _id: {eq: "theHolidays"}
...
const HolidaysFeaturedEventsBlock = (
  props: ComponentPropsWithoutRef<typeof AnchorSection>,
): JSX.Element | null => {
  const {
    featuredEvents,
  } = useStaticQuery<GatsbyTypes.HolidaysFeaturedEventsQuery>(
    HOLIDAYS_FEATURED_EVENTS_QUERY,
  );
...
export default HolidaysFeaturedEventsBlock;

...
const RAINBOW_ROOM_HISTORY_QUERY = graphql`
  query RainbowRoomHistory {
...
const RainbowRoomHistoryBlock = (
  props: Omit<ComponentPropsWithoutRef<typeof AnchorSection>, 'children'>,
): JSX.Element => {
  const {dataJson} = useStaticQuery<GatsbyTypes.RainbowRoomHistoryQuery>(
    RAINBOW_ROOM_HISTORY_QUERY,
  );
...
export default RainbowRoomHistoryBlock;

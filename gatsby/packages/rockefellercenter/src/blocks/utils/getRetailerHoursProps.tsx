 ...
 *
 */
export const getRetailerPrettyTimeString = (time: string): string => {
 ...
 */
export const getRetailerHoursProps = (
  ...
  daysOfTheWeek.map((item) => {
    ...
    if (!sanityHours) {
      ...
      const opensAt =
        sanityHours?.opensAt &&
        getRetailerPrettyTimeString(sanityHours.opensAt);
      const closesAt =
        sanityHours?.closesAt &&
        getRetailerPrettyTimeString(sanityHours.closesAt);

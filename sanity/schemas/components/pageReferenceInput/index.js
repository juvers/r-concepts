...
import styles from "./pageReferenceInput.css";

const noop = () => null;
const imageBuilder = imageUrlBuilder(client);

export default class PageReferenceInput extends React.Component {
  static propTypes = {
          ...
          {loading ? (
            ...
            events.map((event, i) => (
              <button
                ...
                type="button"
                className={
                  current === event._id ? styles.activeButton : styles.button
                }
                onClick={readOnly ? noop : () => this.handleChange(event)}
              >
                <img

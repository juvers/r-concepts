...
const fetchDocuments = () =>
  client.fetch(
    `*[_type in ['attraction.bar', 'attraction.rainbow', 'attraction.rc','attraction.rink', 'attraction.holidays', 'attraction.event', 'attraction.wedding']] {_id, gallery}`
  );

const buildPatches = (docs) =>
  docs.map((doc) => {
    // console.log(doc.gallery.images);
    return {
      id: doc._id,
      patch: {
        set: { "gallery.items": doc.gallery.images },
